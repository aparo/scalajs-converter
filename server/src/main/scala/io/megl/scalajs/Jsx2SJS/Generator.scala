...
object Generator {
  ...
  val propTypesToScala:Map[String,(String, Option[String])] = Map(
    ...
    "React.PropTypes.node" -> ("ReactElement", Some("null")),
    "React.PropTypes.element" -> ("ReactElement", Some("null")),
    ...
    "React.PropTypes.node.isRequired" -> ("ReactElement", None),
    "React.PropTypes.element.isRequired" -> ("ReactElement", None),
